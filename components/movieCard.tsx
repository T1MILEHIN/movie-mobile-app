...
const MovieCard = ({ id, movieId, title, poster_path, poster_url, vote_average, release_date }: MovieCardInterface) => {
    return (
        <Link href={`/movies/${id ?? movieId}`} asChild>
            <TouchableOpacity className='w-[47%] sm:w-[30%]'>
                ...
                {vote_average && <View className='flex-row items-center justify-start gap-x-1'>
